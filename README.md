...
<br>
半田付けする際には、以下の順番に半田付けすると良いでしょう。<br>
　1. U5ソケット（8088/V20のDIPソケット)<br>
　2. J2（20ピンのピンヘッダ（またはピンコネクタ））<br>
　3. J1（20ピンのピンヘッダ（またはピンコネクタ））<br>
　4. その他の半田付け<br>
<br>
...
<br>
（注3）<br>
PIC18F47QXXから512Kメモリをアクセスするために、8088/V20のALE信号に３ステート<br>
バッファを使っています。ALEはメモリアクセスの要になるので、バッファによる<br>
ゲート遅延の影響を考慮する必要があります。<br>
低速の３ステートバッファを使うと正常動作できなくなります。<br>
実装にあたって、注意してください。試作では、東芝TC74AC125Pで動作確認をしています。<br>
74HC125で動作したと報告を頂いております。<br>
<br>
